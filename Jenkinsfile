pipeline {
    ...
    always {
      script {
           emailext body: "Job ${env.JOB_NAME} with buildnumber ${env.BUILD_NUMBER} ended with result : ${currentBuild.result} ! more info ${env.BUILD_URL}. Application's Endpoint : ${STG_APP_ENDPOINT}",
